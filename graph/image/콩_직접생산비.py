...
csv_file = f"/home/user/문서/workspace/python/graph/data/콩_직접생산비.csv"
...
value_label_cols = ["노동비", "위탁영농비"]                 # 수치표시할 2개
legend_cols = ["노동비", "위탁영농비", "비료비", "농구비", "종묘비", "기타비용"]   # 레전드에 개별 표시할 4개
